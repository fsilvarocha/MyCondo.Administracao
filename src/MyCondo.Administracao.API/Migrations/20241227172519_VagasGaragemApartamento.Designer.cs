...
namespace MyCondo.Administracao.API.Migrations
{
    ...
    [Migration("20241227172519_VagasGaragemApartamento")]
    partial class VagasGaragemApartamento
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyCondo.Administracao.Domain.Entities.Apartamento.Apartamentos", b =>
                {
                    ...
                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2024, 12, 27, 14, 25, 18, 360, DateTimeKind.Local).AddTicks(2175));
            ...
            modelBuilder.Entity("MyCondo.Administracao.Domain.Entities.AreaComun.AreaComuns", b =>
                {
                    ...
                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2024, 12, 27, 14, 25, 18, 367, DateTimeKind.Local).AddTicks(3781));
            ...
            modelBuilder.Entity("MyCondo.Administracao.Domain.Entities.Bloco.Blocos", b =>
                {
                    ...
                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2024, 12, 27, 14, 25, 18, 369, DateTimeKind.Local).AddTicks(8561));
            ...
            modelBuilder.Entity("MyCondo.Administracao.Domain.Entities.Condominio.Condominios", b =>
                {
                    ...
                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2024, 12, 27, 14, 25, 18, 372, DateTimeKind.Local).AddTicks(649));
            ...
            modelBuilder.Entity("MyCondo.Administracao.Domain.Entities.Morador.Moradores", b =>
                {
                    ...
                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2024, 12, 27, 14, 25, 18, 373, DateTimeKind.Local).AddTicks(2610));
